...
Each multi-character metacharacter represents a character set that can be used to simplify our regular expression. Here are some 
examples of previous lessons, let's see how we can simplify them:
